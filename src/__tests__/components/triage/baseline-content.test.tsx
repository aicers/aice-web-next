...
// The per-Triage-screen baseline-event drain mount was removed in #651;
// the cadence now lives in the app-shell `AimerPhase2CadenceManager`.
// Its scope-source tests moved out with it.
