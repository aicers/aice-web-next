...
interface QuickPeekInspectorProps {
   ...
   * full width. The shell picks the mode via a media query; the
   * inspector keeps the same body in either case.
   */
  inline?: boolean;
}
 ...
 * the inspector's *contents* land in Phase Detection-18. Until
 * that phase lands we render the summary header (severity / time /
 * kind / sensor) plus a clear placeholder so the row-click
 * contract is visible and the investigation jump stays one click
 * away.
 */
