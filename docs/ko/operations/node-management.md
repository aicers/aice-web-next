...
상태 인디케이터, 서비스 카드(읽기 전용), 적용 미리보기 목록을
확인할 수 있습니다. 단, 수정 / 삭제 / 재시작 / 종료 / 전체 적용,
또는 서비스별 "이 서비스 수정" 어포던스는 모두 노출되지 않습니다.
Phase Node-7 에서 도입될 서비스별 on/off 컨트롤은 #317 PR 2 에서
배포되며, v1 의 이 페이지에는 표시되지 않습니다.
