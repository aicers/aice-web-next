...
**AICE Web**(aice-web-next)의 설치 및 운영 방법을 다룹니다.
...
- **설정** — 계정, 역할, 고객, 정책 관리 및 감사 로그

플랫폼이 발전함에 따라 탐지 이벤트, 조사 워크플로, 트리아지,
리포트 기능이 추가될 예정입니다.
...
- **[시작하기](getting-started.md)** — 사전 요구 사항, 설치,
  첫 로그인
- **[설정](settings.md)** — 계정, 역할, 고객, 정책, 계정 현황
- **[고객사 범위 표시기](customer-scope.md)** — 세션의 고객사
  접근 범위를 보여주는 헤더 표시기와 페이지 단위 안내문
